...
# Usage: ./run_unidp_experiment.sh ditto   OR   ./run_experiments_hd.sh fedavg
...
# dataset flags: {"heart_disease", "mnist", "cifar10", "snli", "fashion_mnist"}
...
GPUID=0
DATA_TYPES=("iid" "niid")  
VERSIONS=("ditto_unidp" "dp_ditto_unidp")
SEEDS=(44 45 46)        # add seeds here
REG_PARAMS=(0 0.001 0.05 0.01 0.1 1.0 2.5 5 7.5 10 15)  # lambda for ditto #0 0.001 0.05 0.01 0.1 1.0 2.5 5 7.5 10
NUM_PERSONAL_STEPS=(10) # number of personalization steps for ditto # 1 2 5 7 10 12 15
EPSILONS=(0.1 0.25 0.5 1 5 10 15)   # values of epsilon for uniform record dp
            ...
            for NUM_PERSONAL_STEP in "${NUM_PERSONAL_STEPS[@]}"; do 
                ...
                echo "--- Lambda $REG_PARAM ---"
                    ...
                    for EPSILON in "${EPSILONS[@]}"; do 
                        ...
                        python dp_ditto_unidp.py --dataset $DATASET --gpuid $GPUID --seed $SEED --data_type $DATA_TYPE --epsilon $EPSILON --reg_param $REG_PARAM --num_personal_steps $NUM_PERSONAL_STEP &
