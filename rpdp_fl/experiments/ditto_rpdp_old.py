...
for ename in epsilons:
    ...
    print(f"Mean performance of rpdp ditto global, Perf={mean_perf_global:.4f}")
    print(f"Mean performance of rpdp ditto personal, Perf={mean_perf_personal:.4f}")
    print(f"Mean performance of rpdp, eps={mean_epsilon}, delta={TARGET_DELTA}, Perf={mean_perf_global:.4f}")
    print(f"Mean performance of rpdp, eps={mean_epsilon}, delta={TARGET_DELTA}, Perf={mean_perf_personal:.4f}")
