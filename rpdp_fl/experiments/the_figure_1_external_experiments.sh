...
#chmod +x the_figure_1_external_experiments.sh
#./the_figure_1_external_experiments.sh
...
for DATA_TYPE in "${DATA_TYPES[@]}"; do
    LOG_FILE="$LOG_DIR/the_figure1_external_15_30_${DATASET}_${DATA_TYPE}_$(date +%Y%m%d_%H%M%S).log"
    ...
    for SEED in "${SEEDS[@]}"; do
        ...
        for NUM_PERSONAL_STEP in "${NUM_PERSONAL_STEPS[@]}"; do
            ...
            for EPSILON in "${EPSILONS[@]}"; do 
                ...
                python ditto_unidp.py --dataset $DATASET \
                --gpuid $GPUID --seed $SEED --data_type $DATA_TYPE \
